...
export default {
  ...
  created () {
    ...
    const vm = this
    const fnNames = ['onMinusPriority', 'onAddPriority', 'onMinusPriority', 'onToggleIsComplete', 'onToggleIsMeeting']
  ...
  methods: {
    ...mapMutations([
      'fakeAddPriority', 'fakeMinusPriority', 'fakeIsComplete', 'fakeIsMeeting'
    ]),
